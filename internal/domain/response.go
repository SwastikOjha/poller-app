...
//		ErrMsg      string    `json:"error_messsage,omitempty"`
...
type Response struct {
	...
	TimeLastUpdateUnix *int             `json:"time_last_update_unix,omitempty"`
	TimeLastUpdateUtc  *string          `json:"time_last_update_utc,omitempty"`
	TimeNextUpdateUnix *int             `json:"time_next_update_unix,omitempty"`
	TimeNextUpdateUtc  *string          `json:"time_next_update_utc,omitempty"`
	BaseCode           *string          `json:"base_code,omitempty"`
	ConversionRates    *ConversionRates `json:"conversion_rates,omitempty"`
